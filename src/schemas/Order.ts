...
export const retrieveOrderPathParamsSchema: SchemaOf<RetrieveOrderPathParamsSchema> = object()
.shape({
    id: string().required()
});
...
export const extendOrderBodySchema: SchemaOf<ExtendOrderBodySchema> = object()
.shape({
...
export const extendOrderBodySchemaPathParamsSchema: SchemaOf<ExtendOrderPathParamsSchema> = object()
.shape({
    id: string().required()
});
...
export const orderConfirmationBodySchema = object()
.shape({
    currency: string().optional(),
    expirationMinutes: number().optional(),
    emailReceipt: boolean().optional(),
...
export const orderConfirmationPathParamsSchema: SchemaOf<OrderConfirmationPathParamsSchema> = object()
.shape({
    id: string().required()
});
...
export const orderCancellationBodySchema: SchemaOf<OrderCancellationBodySchema> = object()
.shape({
...
export const orderCancellationPathParamsSchema: SchemaOf<OrderCancellationPathParamsSchema> = object()
.shape({
    id: string().required()
});